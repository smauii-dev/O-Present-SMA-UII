![O-Present-SMA UII](https://github.com/josephines1/o-present/blob/main/public/assets/img/readme/mockup_opresent.png "O-Present-SMA UII")
...
1. Anda dapat mengunduh kode sumber aplikasi ini dari repositori GitHub Anda dengan tombol "Download ZIP" atau jalankan perintah berikut di terminal Anda:
   ```console
   git clone [https://github.com/Rosyiii/O-Present-SMA-UII.git](https://github.com/Rosyiii/O-Present-SMA-UII.git)
...
> Made by [Ahmad Hanif, SMA UII Yogyakarta](https://smauiiyk.sch.id/), dikembangkan dan diperbarui oleh [Rosyiii](https://github.com/Rosyiii).
