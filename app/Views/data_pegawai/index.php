        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    <a href="<?= base_url('/data-pegawai/downloadTemplate') ?>" class="btn btn-outline-primary me-3">
                    ...
                    <form action="<?= base_url('/data-pegawai/importExcel') ?>" method="post" enctype="multipart/form-data" class="d-flex align-items-center mb-0">
                        <?= csrf_field() ?>
                        <div class="me-2">
